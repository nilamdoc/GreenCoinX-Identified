...
unlocked to sign the Greencoin-Qt.app bundle.
...
allowing somebody to distribute a Greencoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the greencoin-qt.exe file inside the installer had not been tampered with.
