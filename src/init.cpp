...
void Shutdown()
{
    ...
    RenameThread("greencoin-shutoff");
...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        // Parameters
        //
        // If Qt is used, parameters/greencoin.conf are parsed in qt/bitcoin.cpp's main()
        ...
        {
            // First part of help message is specific to greencoind / RPC client
...
int main(int argc, char* argv[])
{
    ...
    // Connect greencoind signal handlers
    noui_connect();
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 9876)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 9875)") + "\n" +
